...
class AboutMethods < Neo::Koan
  ...
  def test_calling_global_methods_with_wrong_number_of_arguments
    exception = assert_raise(ArgumentError) do
      my_global_method  # Calling the method with no arguments, assuming it's incorrect
    end
    assert_match(/wrong number of arguments/, exception.message)  # Expect a message related to argument count
  
    exception = assert_raise(ArgumentError) do
      my_global_method(1, 2, 3)  # Calling the method with too many arguments
    end
    assert_match(/wrong number of arguments/, exception.message)  # Expect a message related to argument count
  end
